...
- MySQL database
- A layered security architecture for the messaging platform, including:
  – Reinforced authentication
  – Secure password management
  – Access control
  – Automated analysis of attachments and URLs via external APIs
...
| Authentication | JWT, OTP / 2FA, password hashing |
| Security | AES encryption, reCAPTCHA, malicious URL/file scanning |
